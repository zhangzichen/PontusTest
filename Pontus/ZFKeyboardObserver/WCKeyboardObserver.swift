...
public class WCKeyboardObserver: NSObject {
	...
	private override init() {
		super.init()
		NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(WCKeyboardObserver.keyboardFrameChange(_:)), name: UIKeyboardWillChangeFrameNotification, object: nil)
	}
